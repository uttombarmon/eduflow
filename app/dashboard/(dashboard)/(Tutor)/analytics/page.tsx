...
const StatCard = ({
  ...
  <div className="bg-white p-6 rounded-3xl border border-slate-200 shadow-sm hover:shadow-md transition-shadow">
    <div className="flex justify-between items-start mb-4">
      ...
      <div
        className={`flex items-center text-xs font-bold ${trend === "up" ? "text-emerald-600 bg-emerald-50" : "text-rose-600 bg-rose-50"} px-2 py-1 rounded-full`}
      >
        {trend === "up" ? (
...
const TopCourseRow = ({
  ...
  <div className="flex items-center gap-4">
    <div
      className={`h-10 w-10 rounded-lg flex items-center justify-center font-bold text-xs ${color}`}
    >
      CS
    </div>
