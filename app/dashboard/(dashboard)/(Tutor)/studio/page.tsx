    ...
    <div className="space-y-8 animate-in fade-in duration-500">
      ...
      <div className="bg-white rounded-3xl border border-slate-200 shadow-sm overflow-hidden">
        <div className="grid grid-cols-12 gap-4 p-4 border-b border-slate-100 bg-slate-50/50 text-xs font-semibold text-slate-500 uppercase tracking-wider">
          <div className="col-span-8 md:col-span-4">Course</div>
          ...
          <div className="col-span-1 hidden md:block text-right">Students</div>
          <div className="col-span-4 md:col-span-3 text-center">Actions</div>
        </div>
